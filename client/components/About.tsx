        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
              B.Tech CSE student (2023–2027) specializing in Data Science &
              Machine Learning. FOSS Club Coordinator at KIT Kanpur. Backend
              developer with experience in Java, Spring Boot, REST APIs. Skilled
              in Python, C, C++, SQL, AWS and Cloud Computing.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-xl p-8"
          >
